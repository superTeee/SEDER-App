# SEDER — App Store-materiell (v1.0)

## Appnavn (maks 30 tegn)
SEDER

## Undertittel (maks 30 tegn)
Sigarjournal og humidor        (23 tegn)

## Kampanjetekst / Promotional text (maks 170 tegn, kan endres uten ny build)
...
## Nøkkelord (maks 100 tegn, komma, ingen mellomrom)
...
## Skjermbilder (trengs fra Tom)

App Store krever minst ett sett iPhone-skjermbilder. Anbefalt sett (6–7 skjermbilder), råfangst fra telefon/simulator — jeg rammer dem inn med tekst-overskrifter etterpå:

1. Utforsk — søk + Brukernes topp 3 / Dagens utvalgte
2. Sigar-detaljside — smaksnoter og styrke-barer
3. Humidor + RH-kort med historikk-graf
4. Logg / vurdering 0–100 (tasting)
5. Skann-flyt
6. Aktivitet — delte innlegg
7. Profil med merker / Merker-side

Størrelser Apple vil ha:
- 6,9"/6,7" iPhone (obligatorisk) — f.eks. 1290×2796 px
- iPad 13" hvis appen støtter iPad
