-- ============================================================
-- 070_add_country_to_get_friend_profile.sql
--
-- Oppdaterer get_friend_profile RPC til å returnere country-feltet.
-- Kolonnen country ble lagt til profiles-tabellen i migrasjon 063.
-- ============================================================
